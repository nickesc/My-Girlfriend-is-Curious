/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b60b74959fdfde0c5ada77b0433c68c3)
// Runtime types generated with workerd@1.20260903.1 2026-09-03 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	PUBLIC_BASE_URL: "https://mgic.nickesc.workers.dev";
	SPOTIFY_CLIENT_ID: "f5d7a507662e4081869efb1771bbb129";
	SPOTIFY_USER_ID: "goofyshnoofy";
	IFTTT_EVENT: "spotify_reauthorization";
	ALLOWED_ORIGINS: "https://nickesc.github.io,https://nickesc.io,https://www.nickesc.io";
	SPOTIFY_CLIENT_SECRET: string;
	IFTTT_KEY: string;
	SPOTIFY_SESSION: DurableObjectNamespace<import("./src/index").SpotifySession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SpotifySession";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_BASE_URL" | "SPOTIFY_CLIENT_ID" | "SPOTIFY_USER_ID" | "IFTTT_EVENT" | "ALLOWED_ORIGINS" | "SPOTIFY_CLIENT_SECRET" | "IFTTT_KEY">> {}
}
